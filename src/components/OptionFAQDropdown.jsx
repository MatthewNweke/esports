    ...
    <div>
      <div className=" mx-auto my-20  w-[50%] max-md:w-[70%] max-sm:w-[90%]">
        <button
          ...
          className={`flex justify-between w-[100%] mb-5 border-0  shadow-sm py-5 rounded-lg px-4  text-[1rem] font-medium text-[white] focus:outline-none 
        ${isOpen1 ? 'bg-slate-700 ' : 'bg-[#343A40]'
            }`}
        >
          When can I deposit/withdraw from my deposit account?
          <svg
            className={`w-5 h-5 ml-2 transition-transform transform ${isOpen1 ? 'rotate-180' : 'rotate-0'
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        {isOpen1 && (
          <div className=" mb-2 shadow-lg text-gray-700 p-2 ring-black ring-opacity-5 w-[100%]">
        ...
        ${isOpen1 ? 'bg-slate-700 ' : 'bg-[#343A40]'
          ...
          <svg
            className={`w-5 h-5 ml-2 transition-transform transform ${isOpen2 ? 'rotate-180' : 'rotate-0'
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        >
          ...
          <svg
            className={`w-5 h-5 ml-2 transition-transform transform ${isOpen3 ? 'rotate-180' : 'rotate-0'
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        >
          ...
          <svg
            className={`w-5 h-5 ml-2 transition-transform transform ${isOpen4 ? 'rotate-180' : 'rotate-0'
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
        ...
        ${isOpen1 ? 'bg-slate-700 ' : 'bg-[#343A40]'
          ...
          <svg
            className={`w-5 h-5 ml-2 transition-transform transform ${isOpen5 ? 'rotate-180' : 'rotate-0'
              }`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
