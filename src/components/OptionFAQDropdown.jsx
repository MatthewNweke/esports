  ...
  return (
    ...
    <div className=" mx-auto my-20  w-[50%] max-md:w-[70%] max-sm:w-[90%]">
      <button
        ...
        className={`flex justify-between w-[100%] mb-5 border  shadow-sm py-5 rounded-lg px-4  border-[#D4B71680]  text-[1rem] font-medium text-[white] focus:outline-none 
        ${
      ...
      <button
        ...
        className={`flex justify-between w-[100%] border mb-5 rounded-lg shadow-sm py-5 px-4  border-[#D4B71680]  text-[1rem] font-medium text-[white] focus:outline-none "
        ${
      ...
      <button
        ...
        className={`flex justify-between w-[100%] rounded-lg mb-5  border border-[#D4B71680]  shadow-sm py-5 px-4 text-[1rem] font-medium text-[white] focus:outline-none
        ${
      ...
      <button
        ...
        className={`flex justify-between w-[100%] border rounded-lg px-4 py-5 mb-5 border-[#D4B71680]  shadow-sm p-4 text-[1rem] font-medium text-[white] focus:outline-none
        ${
      ...
      <button
        ...
        className={`flex justify-between w-[100%]  rounded-lg border border-[#D4B71680]  shadow-sm py-5 px-4 text-[1rem] font-medium text-[white] focus:outline-none"
        ${
