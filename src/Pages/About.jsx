  ...
  return (
    <div>
      <MainLayout>
        ...
        <div className="bg-gradient-to-br from-black py-20 to-opacity-50 text-white">
        ...
        <div
          className="h-[40vh] px-5 w-[50vw] my-16 mx-auto flex flex-col items-center text-center gap-5 justify-center"
          style={{
        ...
        >
          <p className='text-white text-[2.5rem]'>Get Started Today With Us</p>
          <p className='text-white text-[1rem]'>
            This is a Revolutionary Money Making Platform! Invest for Future in
            Stable Platform and Make <br /> Fast Money. Not only we guarantee the
            fastest and the most exciting returns on your investments, <br /> but we
            also guarantee the security of your investment.
          </p>
          <button className='bg-[#D04029] px-8 py-4 rounded-lg'>Join Us</button>
        </div>
      </MainLayout>
    </div>
  );
