...
const StockCard = ({ image, title, description }) => {
  return (
    <div className=" w-[10rem] lg:w-[13rem] shadow-lg xl:w-[15rem] min-[1440px]:w-[18rem]  rounded-lg bg-[#101113] text-[white] hover:bg-[#D04029]  transform hover:scale-200 transition-transform duration-300">
      <img
        src={image}
        alt=""
